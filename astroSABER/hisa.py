...
class HisaExtraction(object):
    def __init__(self, fitsfile, path_to_noise_map=None, path_to_data='.', smoothing='Y', phase='two', lam1=None, p1=None, lam2=None, p2=None, niters=10, iterations_for_convergence = 3, noise=None, add_residual = True, sig = 1.0, velo_range = 15.0, check_signal_sigma = 6., output_flags = True, baby_yoda = False, p_limit=None, ncpus=None):
    ...
    def saber(self):
        ...
        if self.smoothing=='Y':
            ...
            for k in fran(range(len(results_list)), unit='spec', unit_scale=True):
