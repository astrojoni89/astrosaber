        ...
        if radius is not None:
            for i in range(len(coordinates)):
                ...
                for idx, fitsfile in enumerate(fitsfiles):
                    ...
                    ax.plot(velocity[velo_min:velo_max], spectrum[velo_min:velo_max], drawstyle=draw_list[idx], color=color_list[idx])
