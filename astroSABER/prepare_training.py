...
class saberPrepare(object):
    ...
    def prepare_data(self):
        ...
        self.mock_data = {'training_data' : None, 'test_data' : None, 'hisa_spectra' : None, 'hisa_mask' : None, 'signal_ranges' : None, 'bg_fit' : None, 'rchi2' : None, 'rms_noise' : None, 'velocity' : None, 'header' : None}
        self.hisa_spectra = []
        self.training_data = []
        self.test_data = []
        self.hisa_mask = []
    ...
    def prepare_training(self):
        ...
        for i in trange(len(results_list)):
            ...
            lws_of_comps_HISA[np.argwhere(lws_of_comps_HISA<3*spectral_resolution)] = 3*spectral_resolution
